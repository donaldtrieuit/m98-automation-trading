...
const FilterICon = ({ width = 24, height = 24, color = 'white' }: propsIconType) => (
	<svg width={width} height={height} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
		...
		<path
			...
			fill={color}
		/>
		<mask id="mask0_1653_51048" maskUnits="userSpaceOnUse" x="3" y="5" width="7" height="7">
			<path fillRule="evenodd" clipRule="evenodd" d="M3 5.00037H9.2258V11.192H3V5.00037Z" fill="white" />
		</mask>
		<g mask="url(#mask0_1653_51048)">
			<path
				fillRule="evenodd"
				clipRule="evenodd"
